package julie.calendar.Adapters;
...
public class AdapterForTestDB {
     ...
     */
     ...
     private static final String DATABASE_EVENT_CREATE_STATEMENT ="CREATE TABLE event ("+
    ...
    private static final String DATABASE_PLACE_CREATE_STATEMENT = " CREATE TABLE place " +
            " (_id INTEGER not null PRIMARY KEY AUTOINCREMENT,"+
    ...
    private static final String DATABASE_TEACHER_EVENT_CREATE_STATEMENT = "CREATE TABLE teacher_event  " +
            " (_id INTEGER not null PRIMARY KEY AUTOINCREMENT," +
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL(DATABASE_EVENT_CREATE_STATEMENT);
            db.execSQL(DATABASE_PLACE_CREATE_STATEMENT);
            db.execSQL(DATABASE_TEACHER_EVENT_CREATE_STATEMENT);
